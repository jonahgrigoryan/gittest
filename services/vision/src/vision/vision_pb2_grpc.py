...
class VisionServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CaptureFrame = channel.unary_unary(
                '/vision.VisionService/CaptureFrame',
                request_serializer=vision__pb2.CaptureRequest.SerializeToString,
                response_deserializer=vision__pb2.VisionOutput.FromString,
                _registered_method=True)
        self.HealthCheck = channel.unary_unary(
                '/vision.VisionService/HealthCheck',
                request_serializer=vision__pb2.Empty.SerializeToString,
                response_deserializer=vision__pb2.HealthStatus.FromString,
                _registered_method=True)
...
def add_VisionServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CaptureFrame': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=vision__pb2.CaptureRequest.FromString,
                    response_serializer=vision__pb2.VisionOutput.SerializeToString,
            ),
            'HealthCheck': grpc.unary_unary_rpc_method_handler(
                    servicer.HealthCheck,
                    request_deserializer=vision__pb2.Empty.FromString,
                    response_serializer=vision__pb2.HealthStatus.SerializeToString,
            ),
    }
...
class VisionService(object):
    ...
    def CaptureFrame(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/vision.VisionService/CaptureFrame',
            vision__pb2.CaptureRequest.SerializeToString,
            vision__pb2.VisionOutput.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def HealthCheck(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            vision__pb2.HealthStatus.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
