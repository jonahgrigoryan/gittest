...
export type LoggingServiceService = typeof LoggingServiceService;
export const LoggingServiceService = {} as const;

export interface LoggingServiceServer extends UntypedServiceImplementation {
}

export interface LoggingServiceClient extends Client {
}

export const LoggingServiceClient = makeGenericClientConstructor(
  LoggingServiceService,
  "logging.LoggingService",
) as unknown as {
  new (address: string, credentials: ChannelCredentials, options?: Partial<ClientOptions>): LoggingServiceClient;
  service: typeof LoggingServiceService;
  serviceName: string;
};
