...
export interface AgentsServiceServer extends UntypedServiceImplementation {
}

export interface AgentsServiceClient extends Client {
}

export const AgentsServiceClient = makeGenericClientConstructor(
  AgentsServiceService,
  "agents.AgentsService",
) as unknown as {
  new (address: string, credentials: ChannelCredentials, options?: Partial<ClientOptions>): AgentsServiceClient;
  service: typeof AgentsServiceService;
  serviceName: string;
};
